...
// 已上为公共部分	
	...
	var date_full_str="<div class='c_body'><div class='c_top'><div class='c_top_arrows c_top_l'><span>«</span><span>‹</span></div><span align='center' class='c_date'><span></span>年<span></span>月</span><div class='c_top_arrows c_top_r'><span>›</span><span>»</span></div></div><div class='c_mid'><div class='c_main'><div class='c_floor'><span>日</span><span>一</span><span>二</span><span>三</span><span>四</span><span>五</span><span>六</span></div></div></div><div class='c_bottom'><span class='c_getnow'>今天</span></div></div>";
	var date_full_str2="<div class='c_floor'><span></span><span></span><span></span><span></span><span></span><span></span><span></span></div></div>";
...
//		    this.addDate();
	   ...
	   Date_full.prototype.initialize=function(){
	   	  ...
	   	  var o=$(returnObj(date_full_str));
	   	      obj.obj=o;
           obj.arrow=o.find('.c_top_arrows span');
           obj.year=o.find('.c_date span').eq(0);
	   	      obj.month=o.find('.c_date span').eq(1);
	   	      while(i--){str+=date_full_str2};
	   	      o.find('.c_main').append(str);
	   	      obj.span=o.find('.c_floor:gt(0)').find('span');
	   	      obj.getNow=o.find('.c_getnow');
	   	      $('body').append(o);
	   ...
	   Date_full.prototype.addDate=function(){
	    	   ...
	    	   var c=th.addDD.c,t=th.addDD.t;
	    	       while(i<L){
	    	       	   ...
	    	       	   i<c[0][1]?span.eq(i).removeClass('c_allow c_select'):null;
	    	       	   i>=c[1][0]&&i<c[1][1]?span.eq(i).removeClass('c_allow c_select c_today').addClass('c_allow'):null;
	    	       	   i>=c[2][0]&&i<c[2][1]?span.eq(i).removeClass('c_allow c_select c_today'):null;
	    	       	   i++;
	    	       };
	    	       t!=-1?span.eq(t).removeClass('c_allow c_select').addClass('c_today'):null;
	   };
	   Date_full.prototype.Event=function(){
	   	var th=this,arrow=th.obj.arrow,span=th.obj.span;
	   	       arrow.click(function(){
	   	       	  var i=arrow.index($(this));
	   	       	      span.removeClass('c_select');
	   	     ...
	   	     th.obj.obj.on('click','.c_today , .c_allow',function(){
	   	     	       span.removeClass('c_select');
	   	     	   var d=$(this).addClass('c_select').text();
	   	     	       th.date[2]=d;
	   	     	       th.obj.obj.hide();
	   	     	       if(th.callBack)th.callBack(th.date);
	   	     });
